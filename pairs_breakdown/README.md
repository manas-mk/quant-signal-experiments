...
**3. The online CUSUM alarm fired earlier than a stop-loss and cut losses sharply.** Cumulative log P&L after formation:

| Pair | Formation (p-value) | No protection | Stop-loss \|z\| > 3.5 | CUSUM alarm |
|---|---|---|---|---|
| GESHIP / SOMANYCERA | Aug 2019 – Sep 2020 (p = 0.014) | −0.189 | −0.137 (fired after 142 days) | **−0.022** (fired after 56 days) |
| INDUSINDBK / SHRIRAMFIN | Jul 2022 – Jul 2023 (p = 0.004) | −0.437 | −0.104 (after 377 days) | **0.000** (after 330 days) |
...
- **Only two pairs, and both lost money overall.** In that setting any early exit helps. The key open question is the **false-alarm cost**: on pairs that stay profitable, how often does the alarm exit too early?
